...
function deepClone(source) {
  if (React89.isValidElement(source) || !isPlainObject2(source)) {
    return source;
  }
  const output = {};
...
function deepmerge2(target, source, options = {
  ...
  if (isPlainObject2(target) && isPlainObject2(source)) {
    Object.keys(source).forEach((key) => {
      if (React89.isValidElement(source[key])) {
...
var elementAcceptingRef2 = chainPropTypes2(import_prop_types34.default.element, acceptingRef2);
elementAcceptingRef2.isRequired = chainPropTypes2(import_prop_types34.default.element.isRequired, acceptingRef2);
...
var elementTypeAcceptingRef_default2 = chainPropTypes2(import_prop_types35.default.elementType, elementTypeAcceptingRef2);
...
var refType2 = import_prop_types36.default.oneOfType([import_prop_types36.default.func, import_prop_types36.default.object]);
...
function isMuiElement2(element, muiNames) {
  ...
  return React90.isValidElement(element) && muiNames.indexOf(
...
var useEnhancedEffect2 = typeof window !== "undefined" ? React91.useLayoutEffect : React91.useEffect;
...
function useGlobalId2(idOverride) {
  const [defaultId, setDefaultId] = React92.useState(idOverride);
  const id = idOverride || defaultId;
  React92.useEffect(() => {
    if (defaultId == null) {
      globalId2 += 1;
...
var maybeReactUseId2 = React92["useId".toString()];
...
var generateUtilityClass4 = (componentName, slot) => generateUtilityClass3(componentName, slot, "Mui");
var generateUtilityClasses4 = (componentName, slots) => generateUtilityClasses3(componentName, slots, "Mui");
...
function InitColorSchemeScript(options) {
  ...
  return (0, import_jsx_runtime59.jsx)("script", {
...
function useCurrentColorScheme(options) {
  ...
  const setMode = React115.useCallback((mode) => {
  ...
  const setColorScheme = React115.useCallback((value) => {
    if (!value) {
      setState((currentState) => {
        try {
  ...
  const handleMediaQuery = React115.useCallback((event) => {
  ...
  const mediaListener = React115.useRef(handleMediaQuery);
...
function createCssVarsProvider(options) {
  ...
  const ColorSchemeContext = React116.createContext(void 0);
  if (true) {
    ColorSchemeContext.displayName = "ColorSchemeContext";
  }
  const useColorScheme = () => {
    const value = React116.useContext(ColorSchemeContext);
    if (!value) {
  ...
  function CssVarsProvider(props) {
    ...
    const hasMounted = React116.useRef(false);
    const upperTheme = useTheme3();
    const ctx = React116.useContext(ColorSchemeContext);
    ...
    const element = (0, import_jsx_runtime61.jsxs)(React116.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime61.jsxs)(React116.Fragment, {
        children: [(0, import_jsx_runtime60.jsx)(GlobalStyles, {
          styles: {
            [colorSchemeSelector]: rootCss
          }
        }), (0, import_jsx_runtime60.jsx)(GlobalStyles, {
          styles: defaultColorSchemeStyleSheet
        }), (0, import_jsx_runtime60.jsx)(GlobalStyles, {
          styles: otherColorSchemesStyleSheet
        })]
      }), (0, import_jsx_runtime60.jsx)(ThemeProvider_default2, {
    ...
    return (0, import_jsx_runtime60.jsx)(ColorSchemeContext.Provider, {
      value: contextValue,
      children: element
    });
  }
...
function createContainer(options = {}) {
  ...
  const Container2 = React117.forwardRef(function Container3(inProps, ref) {
...
function createGrid(options = {}) {
  ...
  const GridOverflowContext = React118.createContext(void 0);
  if (true) {
  ...
  const Grid2 = React118.forwardRef(function Grid3(inProps, ref) {
    var _inProps$columns, _inProps$spacing, _ref, _inProps$rowSpacing, _ref2, _inProps$columnSpacin, _ref3, _disableEqualOverflow;
    const theme = useTheme_default();
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const overflow2 = React118.useContext(GridOverflowContext);
    const {
      className,
      children,
    ...
    let result = (0, import_jsx_runtime63.jsx)(GridRoot, _extends({
      ...
      children: React118.Children.map(children, (child) => {
        if (React118.isValidElement(child) && isMuiElement2(child, ["Grid"])) {
...
function joinChildren(children, separator) {
  ...
  return childrenArray.reduce((output, child, index2) => {
    ...
    if (index2 < childrenArray.length - 1) {
      output.push(React119.cloneElement(separator, {
...
function createStack(options = {}) {
  ...
  const Stack2 = React119.forwardRef(function Grid2(inProps, ref) {
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const {
      component = "div",
...
export {
  ...
  generateUtilityClasses4 as generateUtilityClasses,
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-4GSKIAQP.js.map
